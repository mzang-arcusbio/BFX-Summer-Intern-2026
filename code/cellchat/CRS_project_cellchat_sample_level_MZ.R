...
cellchat.list <- lapply(sample_list, function(seu) {
...
saveRDS(cellchat.list, '~/project/results_nofilter_gene/integration_harmony/cellchat/cellchat_obj_by_sample_celltype3.rds')
